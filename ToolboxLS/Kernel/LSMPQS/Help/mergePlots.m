function mergePlots(d0,d1,d2,d3,g,mask,d1_title,d2_title,d3_title)
% function mergePlots(d0,d1,d2,d3,g,mask,d1_title,d2_title)
% function mergePlots(d0,d1,d2,d3,g,mask,d1_title,d2_title,d3_title)
...
if( flip )
  ...
  [ garbage, hD3 ] = contour(g.xs{1}, g.xs{2}, d3, lev, 'm-');
  
  
  hs = [ hI; hD1; hD2; hD3; hM];
