function readMergePlotsGray(pathstr,step1,step2,step3,step4,step5)
...
d3_title = sprintf('c = %2.2f',0.6824);
%d3_title = sprintf('c = %2.2f',curvconst(step3));
if(nargin <= 4)
    % d3 will have name "final"
    mergePlotsGray(data0,data1,data2,data3,g,mask,d1_title,d2_title,d3_title);
else
