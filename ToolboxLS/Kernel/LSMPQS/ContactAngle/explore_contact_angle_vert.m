function [angle median_angle mean_angle] = explore_contact_angle_vert(infl_name1,infl_name2,do_vis)
...
[angle median_angle mean_angle] = explore_contact_angle_vert_main(data1,data2,nx,ny,nz,isolevel,do_vis,color);
